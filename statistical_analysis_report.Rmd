...
To simplify analysis of diagnoses, the various diagnoses were divided into categories based on the ICD9 Codes.  The diagnosis categories with the highest ratio between diabetic and non-diabetic patients are Circulatory and Endocrine/Nutritional/Metabolic.
